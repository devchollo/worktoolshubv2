...
export const toolCategories = {
  "note-generators": {
    ...
    color: "#10b981",
    tools: [
      { name: "OSAD Note Generator", path: "/tools/osad-note-generator", internal: true, pending: true  },
      ...
      { name: "Meta Description Tool", path: "/tools/meta-description", pending: true  },
      { name: "Blog Post Outlines", path: "/tools/blog-outline", pending: true  },
    ],
  },
  "email-tools": {
    name: "Email Tools",
    ...
    tools: [
      ...
      { name: "Offline Mods Notes & Email Generator", path: "/tools/offline-mods-note-email-generator", internal: true },
      { name: "Launch Announcement", path: "/tools/launch-announcement", internal: true, pending: true  },
  ...
  "file-tools": {
    ...
    color: "#f59e0b",
    tools: [
      { name: "Image Compressor", path: "/tool/image-compressor", pending: true },
  ...
  "business-tools": {
    ...
    tools: [
      ...
      { name: "Schema Generator", path: "/tool/schema-generator", pending: true },
      { name: "Invoice Creator", path: "/tool/invoice-creator", pending: true },
      { name: "Report Templates", path: "/tool/report-templates", pending: true },
    ],
  },
  "design-tools": {
    ...
    color: "#ec4899",
    tools: [
      { name: "Logo Placeholder", path: "/tool/logo-placeholder", pending: true },
      { name: "Color Palette", path: "/tool/color-palette", pending: true },
      { name: "Icon Generator", path: "/tool/icon-generator", pending: true },
      { name: "Social Media Templates", path: "/tool/social-templates", pending: true },
    ],
  },
};
